...
* Использование Linq
* Знание и использование некоторых паттернов проектирования (Observer, Object Pool, Singleton и тд)
* Базовый знания по DOTween (Анимация UI, движение объектов)
* Использование DI containers, Zenject/Reflex
+ Умения отпимизировать игру (пулинг объектов, SpriteAtlas, кеширование и тд)
